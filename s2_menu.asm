...
;-------------------------------------------------------------------------------
                lea     ($FFFF0000), A1 ;îáðàùàåìñÿ ê àäðåñó, ãäå çàãðóæàþöà 256õ256 ìàïïèíãè
                lea     (Menu_Mappings), A0 ;çàãðóæàåì èõ (ñîáñíà, ýòî ôîí ìåíþ)
                move.w  #$6000, D0
                bsr     Menu_EnigmaDec ;ðàçæèìàåì èõ
                lea     ($FFFF0000), A1
                move.l  #$60000003, D0
                moveq   #$27, D1 ;cols
                moveq   #$1B, D2 ;rows
                bsr     Menu_ShowVDPGraphics ;ïîêàçûâàåì
;-------------------------------------------------------------------------------                
...
;-------------------------------------------------------------------------------                
                ...
                clr.w   ($FFFFF7F0).w
;------------------------------------------------------------------------------- 
                move.b  #$0000, ($FFFFF7B8).w  ; Inicializa os quadros das animações do menu
...
;                cmpi.b	#$01,($FFFFFF8C).w
;                beq.s   MightyLoadingSub
;                cmpi.b	#$02,($FFFFFF8C).w
;                beq.s   MetalLoadingSub
;                cmpi.b	#$03,($FFFFFF8C).w
;                beq.s   TikalLoadingSub
;                cmpi.b	#$04,($FFFFFF8C).w
;                beq.s   ShadowLoadingSub
;                cmpi.b	#$05,($FFFFFF8C).w
;                beq.s   EspioLoadingSub
;                move.b	#$00,($FFFFFF82).w
;                bra.s   Menu_Load_Level_Rts

;MightyLoadingSub:
;                move.b	#$01,($FFFFFF8B).w
;                bra.w   Menu_Load_Level_Rts

;MetalLoadingSub:
;                move.b  #$02,($FFFFFF8B).w
;                bra.w   Menu_Load_Level_Rts

;TikalLoadingSub:
;                move.b  #$03,($FFFFFF8B).w
;                bra.w   Menu_Load_Level_Rts

;ShadowLoadingSub:
;                move.b  #$04,($FFFFFF8B).w
;                bra.w   Menu_Load_Level_Rts

;EspioLoadingSub:
;                move.b  #$05,($FFFFFF8B).w
;
Menu_Load_Level_Rts:
                rts
...
Menu_Level_Select_Text: 
                dc.b    $0E, _T, _R, _O, _P, _I, _C, _A, _N, _A, __, __, __, __, __, __
                dc.b    $0E, _C, _H, _A, _O, _S, __, _S, _H, _R, _I, _N, _E, __, __, __
                dc.b    $0E, _N, _E, _C, _R, _O, _P, _O, _L, _I, _S, __, __, __, __, __
                dc.b    $0E, _R, _O, _B, _O, _T, _R, _O, _P, _O, _L, _I, _S, __, __, __
                dc.b    $0E, _D, _I, _R, _E, __, _T, _R, _E, _E, _T, _O, _P, _S, __, __
                dc.b    $0E, _H, _Y, _D, _R, _O, _S, _T, _A, _T, _I, _O, _N, __, __, __
                dc.b    $0E, _S, _T, _A, _T, _I, _O, _N, __, _C, _O, _R, _E, __, __, __   
