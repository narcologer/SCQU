...
loc_3270_2:
	...
	;	bne.w	SegaLogo_MD_2
		...
		move.l	#$45B00003,($C00004).l  ; Add
		move.l	#$00300031,($C00000).l  ;     TM
SegaLogo_MD:
		jsr	Pal_FadeTo
...
ArtUnc_SegaLogoClassic:
		incbin	"Modes\SegaScreen1\GFX.bin"
		even
	
Maps_SegaLogoClassic:
		dc.w $01, $02, $03, $04, $05, $06, $07, $08, $09, $0A, $0B, 0
...
Pal_SegaLogoClassic:
		incbin	"Modes\SegaScreen1\PAL.bin"
		even


PalCyc_SegaLogoClassic:
		incbin	"Modes\SegaScreen1\ANIPAL.bin"
		even
